...
LiveTrackingProductPlaceModel liveTrackingProductPlaceModelFromJson(String str) => LiveTrackingProductPlaceModel.fromJson(json.decode(str));

String liveTrackingProductPlaceModelToJson(LiveTrackingProductPlaceModel data) => json.encode(data.toJson());

class LiveTrackingProductPlaceModel {
  List<Prediction>? predictions;
  String? status;

  LiveTrackingProductPlaceModel({
    this.predictions,
    this.status,
  });

  factory LiveTrackingProductPlaceModel.fromJson(Map<String, dynamic> json) => LiveTrackingProductPlaceModel(
